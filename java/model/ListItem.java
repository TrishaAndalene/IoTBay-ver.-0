...
public class ListItem implements Serializable{
    ...
    public void createProduct(String name, String brand, Double price, String colour, String size, int quantity, Categories category){
        Product product = new Product(name, brand, price, colour, size, quantity, category);
