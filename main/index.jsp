...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/webapp/css/Landing.css">

</head>
<body>
    <header>
        <!-- main company logo -->
        <img id="company_logo" src="http://localhost:8080/webapp/img/company_logo.png">
        <!-- compnay name -->
    ...
    <nav>
        ...
        <button id="login_btn"><a href="http://localhost:8080/webapp/jsp/Login.jsp">LOGIN</a></button>
        <button id="signup_btn"><a href="http://localhost:8080/webapp/jsp/Signup.jsp">SIGN UP</a></button>
    </nav>

    <!-- main screen -->
    <div id="main_screen">
        <img id="main_background" src="http://localhost:8080/webapp/img/main_image.png">
        <p id="promotion_title">Promotion Title</p>
        <p id="promotion_line">Promotion line</p>
        <div id="order_btn"><a href="http://localhost:8080/webapp/jsp/Order.jsp">ORDER NOW</a></div>
    </div>
    ...
    <div id="second_screen">
        ...
        <div class="frame_2nd" id="frame1_2">
            <img class="frame_2nd_img" id="frame_2nd_img1" src="http://localhost:8080/webapp/img/diamond.jpg">
            <p class="product_name">NAME</p>
        </div>
        <!-- frame2 -->
        <div class="frame_2nd" id="frame2_2">
            <img class="frame_2nd_img" id="frame_2nd_img2" src="http://localhost:8080/webapp/img/diamond.jpg">
            <p class="product_name">NAME</p>
        </div>
        <!-- frame3 -->
        <div class="frame_2nd" id="frame3_2">
            <img class="frame_2nd_img" id="frame_2nd_img3" src="http://localhost:8080/webapp/img/diamond.jpg">
            <p class="product_name">NAME</p>
        </div>
        <!-- Arrow Sign -->
        <button>
            <img class="arrow" id="arrow_left" src="http://localhost:8080/webapp/img/left.png">
        </button>
        <button>
            <img class="arrow" id="arrow_right" src="http://localhost:8080/webapp/img/right.png">
        </button>
        <!-- slideshow -->
    ...
    <div id="customer_favourite">
        ...
        <div class="frame_3rd" id="frame3_3">
            <img class="frame_3rd_img" id="frame_3rd_img3" src="http://localhost:8080/webapp/img/stair.jpg">
            <p class="price">$17.99 AUD</p>
            <button class="order_btn">ORDER NOW</button>
        </div>
    </div>
    ...
    <div id="latest_reviews">
        ...
        <div id="review_section">
            <div>
                <!-- img -->
                <img id="review_img" src="http://localhost:8080/webapp/img/diamond.jpg">
            </div>
            <div id="wall"></div>
        </div>.
        <!-- Arrow Sign -->
        <button>
            <img class="arrow" id="arrow_left2" src="http://localhost:8080/webapp/img/left.png">
        </button>
        <button>
    ...
    <div id="company_detail">
        ...
        <div class="image-stack">
            <img src="http://localhost:8080/webapp/img/diamond.jpg" class="stacked-img" style="z-index: 4;">
            <img src="http://localhost:8080/webapp/img/diamond.jpg" class="stacked-img" style="z-index: 1;">
            <img src="http://localhost:8080/webapp/img/diamond.jpg" class="stacked-img" style="z-index: 2;">
            <img src="http://localhost:8080/webapp/img/diamond.jpg" class="stacked-img" style="z-index: 3;">
        </div>
        <!-- company text -->
        <div id="company_text">
