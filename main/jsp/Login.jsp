...
<head>
    ...
    <script src="http://localhost:8080/webapp/js/login_script.js"></script>
    
    <link rel="stylesheet" href="http://localhost:8080/webapp/css/Signin.css">
    ...
    <section class="login">
        <div class="left-1">
            <div class="left-content">
                ...
                <button><a href="http://localhost:8080/webapp/jsp/Signup.jsp"><h4>Sign up</h4></a></button>
            </div>
        </div>
