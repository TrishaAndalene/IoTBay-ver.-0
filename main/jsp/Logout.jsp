...
<head>
    ...
    <script src="http://localhost:8080/webapp/js/logout_script.js"></script>
    
    <link rel="stylesheet" href="http://localhost:8080/webapp/css/Logout.css">
</head>
    ...
    <section class="logOut" id="page-2">
        <div class="page-2">
            ...
            <div class="text-only">
                ...
                <img src="http://localhost:8080/webapp/img/okaySym.svg" alt="symbol" id="okay">
            </div>
            <br><br>
