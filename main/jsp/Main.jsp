...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/webapp/css/Main.css">
...
<body>
    ...
    <nav>
        ...
        <button id="signup_btn"><a href="http://localhost:8080/webapp/jsp/Logout.jsp">LOG OUT</a></button>
    </nav>
