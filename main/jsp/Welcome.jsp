...
<head>
    ...
    <script src="http://localhost:8080/webapp/js/welcome_script.js"></script>
    
    <link rel="stylesheet" href="http://localhost:8080/webapp/css/Welcome.css">
...
<body onload="continuePage(1)">
    <section class="welcome" id="page-1">
        <div class="page-1">
            <img src="http://localhost:8080/webapp/img/welcome_logo.png" alt="logo">
    ...
    <section class="welcome" id="page-2">
        <div class="page-2">
            <img src="http://localhost:8080/webapp/img/welcome_logo.png" alt="logo" id="smallerPng">
            <br><br><br>
    ...
    <section class="welcome" id="page-3">
        <div class="page-3">
            ...
            <br><br>
            <video controls>
                <source src="http://localhost:8080/webapp/vid/video1.mp4" type="video/mp4">
            </video>
            <br><br><br>
    ...
    <section class="welcome" id="page-4">
        <div class="page-4">
            ...
            <br><br>
            <button><a href="http://localhost:8080/webapp/jsp/Main.jsp"><h4>Start Exploring!</h4></button>
        </div>
    </section>
</body>
</html>